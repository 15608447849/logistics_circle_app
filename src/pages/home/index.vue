<template>
  <div>
    ...
    <yd-button type="primary" @click.native="toSubmitOrder">发单测试</yd-button>
    <!--首页轮播-->
    <div class="binnar">
    ...
    <div class="content">
        <div class="order">
           ...
           <div class="snag_order">
             <div class="order_img"></div>
             <span>已抢订单</span>
           </div>
        </div>
        <div class="bold_line"></div>
        <div class="order_box"><span class="good_order">----为你精选的好订单----</span></div>
      <!--订单列表-->
      <ul class="order_box">
        <li class="order_list">
