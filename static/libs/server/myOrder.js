...
(function(module, require, exports)
{
    ...
    Slice.defineOperations(myOrder.MyOrderServer, myOrder.MyOrderServerPrx,
    {
        ...
        "getOrderTrajectory": [, , , , , [7], [[cstruct.UserParam], [3], [7]], , , , ],
        "getOrderTraByOrderid": [, , , , , [7], [[cstruct.UserParam], ["cstruct.stringSeqHelper"], [3]], , , , ],
        "getAreaData": [, , , , , [myOrder.AreaData], [[7]], , , , ],
        "acceptTravel": [, , , , , [3], [[4], [3], [4], [7]], , , , ],
        "acceptTravelCorrect": [, , , , , [3], [[4], [3], [4], [7]], , , , ],
        "entryTravel": [, , , , , [7], [[myOrder.TracOfOrder]], , , , ],
        "refuseOrder": [, , , , , [7], [[cstruct.UserParam], [7]], , , , ],
        "receiveOrder": [, , , , , [7], [[cstruct.UserParam], [7]], , , , ],
        "getTransferPoint": [, , , , , ["myOrder.AreaDataSeqHelper"], [[3]], , , , ],
        "getPickCode": [, , , , , [7], [[cstruct.UserParam], [7]], , , , ],
        "checkPickPwd": [, , , , , [7], [[cstruct.UserParam], [7], [7]], , , , ],
        "insertOrderEvaluate": [, , , , , [7], [[myOrder.OrderEvaluate]], , , , ],
        "conReceipt": [, , , , , [7], [[7], [cstruct.UserParam]], , , , ],
        "getOrderDetail": [, , , , , [7], [[7], [cstruct.UserParam], [3]], , , , ],
        "getOrderDetailByRepub": [, , , , , [7], [[7], [cstruct.UserParam], [3]], , , , ],
        "updateMyPublishOrder": [, , , , , [7], [[myOrder.OrderICE], [cstruct.UserParam]], , , , ],
        "transOrder": [, , , , , [7], [[myOrder.OrderICE], [cstruct.UserParam]], , , , ],
        "getOrderInfo": [, , , , , [7], [[7], [cstruct.UserParam], [3]], , , , ],
        "flushOrder": [, , , , , [7], [[cstruct.UserParam], [7]], , , , ],
        "cancelOrder": [, , , , , [7], [[7], [cstruct.UserParam]], , , , ],
        "repubOrder": [, , , , , [7], [[7], [cstruct.UserParam]], , , , ],
        "closeOrder": [, , , , , [7], [[7], [cstruct.UserParam]], , , , ],
        "cancelRobbing": [, , , , , [7], [[7], [cstruct.UserParam]], , , , ],
        "getOrderEvaluate": [, , , , , ["myOrder.OrderEvaluateSeqHelper"], [[3]], , , , ],
        "getTrancCode": [, , , , , [7], [[cstruct.UserParam], [7], [3]], , , , ],
